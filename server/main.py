...
from electronic_instrument_adapter.protocol.communication_protocol import OpenLisaCommunicationProtocol
...
def main():
    ...
    open_lisa_communication_protocol = OpenLisaCommunicationProtocol(rs232_config, args.tcp_port)
